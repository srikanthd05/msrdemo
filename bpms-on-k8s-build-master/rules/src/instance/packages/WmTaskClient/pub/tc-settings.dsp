                        ...
                        <FORM name="testform" method="post" action="tc-settings.dsp">
							...
							<TR>
                                ...
                                <script>writeTD("row-l");</script>
									<select name="taskserver" id="task-server" onchange="updateTaskServerURL()">
										<option value="INPROC">In Proc</option>
										<option value="REMOTE_MWS">Remote MWS</option>
										<option value="REMOTE_IS">Remote IS</option>
									</select>
                                </TD>
	                        </TR>
							
                            <TR id="task-server-url">
                                <script>writeTD("row");</script>
                                    Task Server URL &nbsp;&nbsp;
                                </TD>
                                <script>writeTD("row-l");</script>
		                    ...
		                    <script>swapRows();setTaskServer('%value taskserver%');updateTaskServerURL();</script>
                            ...
                            <TR>
                                ...
                                <script>writeTD("row-l");</script>
                                    <INPUT name="taskclientusejms" value="%value taskclientusejms%"/>
                                </TD>
	                        </TR>
