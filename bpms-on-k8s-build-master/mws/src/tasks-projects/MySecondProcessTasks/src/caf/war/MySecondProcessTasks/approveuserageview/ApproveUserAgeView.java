...
@ManagedBean(name = "ApproveUserAgeView")
@SessionScoped
@ExpireWithPageFlow
@DTManagedBean(displayName = "ApproveUserAgeView", beanType = BeanType.PORTLET)
public class ApproveUserAgeView  extends   com.webmethods.caf.faces.bean.BaseFacesPreferencesBean {
